...
find ./packages/*/package.json -exec sed -i '' -e 's|public|private|g' {} \;
find ./packages/*/*/*.ts -exec sed -i '' -e "s|customElement('mwc-|customElement('gsk-mwc-|g" {} \;
find ./packages/*/*/*.ts -exec sed -i '' -e "s|customElements.define(\'mwc-|customElements.define(\'gsk-mwc-|g" {} \;
find ./packages/*/*/*.ts -exec sed -i '' -e "s|'mwc-|'gsk-mwc-|g" {} \;å
